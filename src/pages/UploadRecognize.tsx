  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        {/* Upload area - MOBILE FIX: use onClick instead of label */}
        {!uploadedImage ? (
          <div
            onClick={triggerFileInput}
            className="flex flex-col items-center justify-center h-64 border-2 border-dashed border-gray-300 rounded-2xl cursor-pointer hover:border-pink-400 hover:bg-pink-50/20 transition-all bg-white active:scale-[0.98]"
            role="button"
            tabIndex={0}
          >
            ...
            <span className="text-sm font-medium text-gray-600">点击上传订单截图</span>
            <span className="text-xs text-gray-400 mt-1.5">支持小红书/淘宝/京东等电商订单</span>
            <input
              ref={fileInputRef}
              type="file"
              accept="image/*"
